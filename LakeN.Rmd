...
for (ii in 1:length(datediff_all)){
  # define which process is dominating the N cycle
  for (jj in 1:length(data1.split.interp.quant.df$Depth)){
    if  (data1.split.interp.quant.df$Depth[[jj]]) 
  }
}
