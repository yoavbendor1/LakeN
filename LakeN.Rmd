...
```{r best fit estimation, echo=FALSE, warning=FALSE, message=FALSE, out.width = '600px', out.height = '300px'}
...
nitrate.buildup.parameters=template
NH4.buildup.parameters=template
nitrate.consumption.parameters=template
NH4.consumption.parameters=template

temp=vector("list", length=0)
temp=split(Nitrate.model.df,f=Nitrate.model.df$Depth)

for (ii in 1:length(temp)){
nitrate.buildup.parameters$a_best[ii]=temp[[ii]]$a[which.max(temp[[ii]]$r2)]
nitrate.buildup.parameters$a_max[ii]=max(temp[[ii]]$a)
nitrate.buildup.parameters$a_min[ii]=min(temp[[ii]]$a)

nitrate.buildup.parameters$b_best[ii]=temp[[ii]]$b[which.max(temp[[ii]]$r2)]
nitrate.buildup.parameters$b_max[ii]=max(temp[[ii]]$b)
nitrate.buildup.parameters$b_min[ii]=min(temp[[ii]]$b)
}

for (ii in 1:length(temp)){
NH4.buildup.parameters$a_best[ii]=temp[[ii]]$a[which.max(temp[[ii]]$r2)]
NH4.buildup.parameters$a_max[ii]=max(temp[[ii]]$a)
NH4.buildup.parameters$a_min[ii]=min(temp[[ii]]$a)

NH4.buildup.parameters$b_best[ii]=temp[[ii]]$b[which.max(temp[[ii]]$r2)]
NH4.buildup.parameters$b_max[ii]=max(temp[[ii]]$b)
NH4.buildup.parameters$b_min[ii]=min(temp[[ii]]$b)
}

for (ii in 1:length(temp)){
nitrate.consumption.parameters$a_best[ii]=temp[[ii]]$a[which.max(temp[[ii]]$r2)]
nitrate.consumption.parameters$a_max[ii]=max(temp[[ii]]$a)
nitrate.consumption.parameters$a_min[ii]=min(temp[[ii]]$a)

nitrate.consumption.parameters$b_best[ii]=temp[[ii]]$b[which.max(temp[[ii]]$r2)]
nitrate.consumption.parameters$b_max[ii]=max(temp[[ii]]$b)
nitrate.consumption.parameters$b_min[ii]=min(temp[[ii]]$b)
}

for (ii in 1:length(temp)){
NH4.consumption.parameters$a_best[ii]=temp[[ii]]$a[which.max(temp[[ii]]$r2)]
NH4.consumption.parameters$a_max[ii]=max(temp[[ii]]$a)
NH4.consumption.parameters$a_min[ii]=min(temp[[ii]]$a)

NH4.consumption.parameters$b_best[ii]=temp[[ii]]$b[which.max(temp[[ii]]$r2)]
NH4.consumption.parameters$b_max[ii]=max(temp[[ii]]$b)
NH4.consumption.parameters$b_min[ii]=min(temp[[ii]]$b)
}

# create a vector with all the date differences of the measurments
temp=split(data1.split.interp.quant.df, f=data1.split.interp.quant.df.year$Depth)
temp2=datedifference(temp)
datediff_all=temp2[[1]][[1]]

modelled.data=data.frame(data=NA)

colnames(modelled.data)=colnames(data1.split.interp.quant.df)
modelled.data=data1.split.interp.quant.df


#  for (jj in 1:length(data1.split.interp.quant.df$Date)){
#    if  (data1.split.interp.quant.df$Depth[[jj]] < oxycline.depth[[2]]) 
#  }
