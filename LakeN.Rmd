...
model.data.2=lakeNH4(max.depth=40, model.data=model.data,mean.rand.NH4=3e5, sd.rand.NH4=3e5/5, mix.index=as.Date("2010-06-06"), data.dates=as.Date(unique(data.for.model$Date)), mix.delay.ind=0, first.mix=as.Date("2011-06-05"), NH4.comsumption.correction.factor=3, parameters.NH4.consumption=parameters.NH4.consumption.2, date.dif.for.model.seq=date.dif.for.model.seq, oxycline.depth.date=oxycline.depth.date,mixing.ratio.NH4=0.9,crit.depth=35, parameters.NH4.buildup=parameters.NH4.buildup.2, dur2=30, dur3=120, first.mix.delay.ind=1.5*dur3)

#test=sapply(model.data, lakeNH4(model.data=model.data,mean.rand.NH4=3e5, sd.rand.NH4=3e5/10, mix.index=as.Date("2010-06-06"), data.dates=as.Date(unique(data.for.model$Date)), mix.delay.ind=0, first.mix=as.Date("2011-06-05"), NH4.comsumption.correction.factor=1, parameters.NH4.consumption=parameters.NH4.consumption.2, date.dif.for.model.seq=date.dif.for.model.seq, oxycline.depth.date=oxycline.depth.date,crit.depth=35, parameters.NH4.buildup=parameters.NH4.buildup.2, dur2=30, dur3=120, first.mix.delay.ind=1.5*dur3))
