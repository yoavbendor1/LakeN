...
# attach the appropriate depth for each measurment using available daily level measurments
```{r eval=TRUE, echo=FALSE}
...
```
# multiply each depth value with its corresponding hypsometric value
```{r eval=TRUE, echo=FALSE}
