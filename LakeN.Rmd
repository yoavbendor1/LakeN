...
for (ii in 1:length(x.depth)){
  findinterval(depth.for.model[[1]]
  depth.for.model[[x.depth[ii]]]=data1.split.interp.quant.df[depth.indices,]
}
nh4.buildup=
...
d=d+scale_colour_gradient2(low = "blue",mid = "green" , high = "red", midpoint=(max(depth.for.model[[1]]$Oxygen)-min(depth.for.model[[1]]$Oxygen))/2)
