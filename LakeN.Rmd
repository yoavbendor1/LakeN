...
In this model a simplistic approach is applied in order to examine the possibility to model the transition between oxydized and reduced species in the lake. Due to the complexity of the processes, and the plethora of available data, the simplistic approach in this model relies on four key processes:

1. Nitrification in oxydized conditions
2. Ammonification in suboxic to anoxic conditions
3. Ammonium consumption in the photic zone
4. Lake mixing
